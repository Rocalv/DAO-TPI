...
class TipoMulta:
    ...
    @staticmethod
    def registrar(motivo, descripcion, monto_sugerido):
    ...
    def filtrar_por_id(self):
        ...
        try:
            conn = db.get_connection()
            cursor = conn.cursor()
            cursor.execute("SELECT * FROM tipos_multa WHERE id_tipo_multa = ?", (self.id_tipo_multa,))
    ...
    @staticmethod
    def actualizar(self, motivo, descripcion, monto_sugerido):
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHERE id_tipo_multa = ?
            """, (motivo, descripcion, monto_sugerido, self.id_tipo_multa))
            db.commit()
            return True
        except Exception as e:
    ...
    def eliminar(self):
        ...
        try:
            conn = db.get_connection()
            cursor = conn.cursor()
            cursor.execute("DELETE FROM tipos_multa WHERE id_tipo_multa = ?", (self.id_tipo_multa,))
            db.commit()
            return True
        except Exception as e:
    ...
    def get_id_tipo_multa(self):
        return self.id_tipo_multa