...
class EmpleadoView(tk.Frame):
    ...
    def create_widgets(self):
        ...
        tk.Button(form_frame, text="Seleccionar Foto...", command=self.controller.seleccionar_foto, bg=BTN_BG_COLOR, fg=BTN_FG_COLOR).grid(row=3, column=5, padx=5, pady=5, sticky="nsew")
        ...
        self.tree.bind("<<TreeviewSelect>>", self.controller.seleccionar_empleado)
