# frontend/views/consultar_mantenimiento_view.py
...
class ConsultarMantenimientoView(tk.Frame):
    ...
    def create_widgets(self):
        # Título
        tk.Label(self, text="Mantenimientos en Curso (Pendientes)", bg=BG_COLOR, fg=FG_COLOR, font=("Helvetica", 16, "bold")).pack(pady=(20, 10))
        ...
        # Columnas solicitadas: Vehículo, Servicio, Fecha Inicio... agregué Proveedor para completar
        ...
        tk.Button(btn_frame, text="✅ Finalizar Mantenimiento Seleccionado", 
                  command=self.controller.finalizar_mantenimiento, 
                  bg="#2e7d32", fg="white", font=("Helvetica", 12, "bold"), padx=20, pady=10).pack()
    ...
    def obtener_id_seleccionado(self):
        """Retorna el ID del mantenimiento seleccionado."""
        selected = self.tree.selection()
        if not selected: return None
        # El ID está en la primera columna (values[0])
